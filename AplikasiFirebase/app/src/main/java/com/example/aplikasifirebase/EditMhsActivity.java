...
public class EditMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://praktikum-firebase-c2aad-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("mhs").child(nim);
